...
%
%Define 3D array for state-level data - Master_st(row, column, page)
...
%%
%Sum up spacified state-level data for custom areas.  Parameters defining 
...
%flip array up/down & fill date column starting at datenum for 2/28/20
T_temp = flipud(Testing_us);
Testing_us = T_temp;
for i = 1:H_HT
    Testing_us(i,1) = 737848+i;
end
